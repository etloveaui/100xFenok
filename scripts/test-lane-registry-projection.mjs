 ...
 * - Emitter unit: 28 lanes, exact allowed key set, owner_workflow basename only.
 */
...
assert.equal(projection.lanes.length, 28, "projection must carry all 28 registry lanes");
assert.equal(projection.lane_count, 28);
