 ...
 * - Emitter unit: 21 lanes, exact allowed key set, owner_workflow basename only.
 */
...
assert.equal(projection.lanes.length, 21, "projection must carry all 21 registry lanes");
assert.equal(projection.lane_count, 21);
