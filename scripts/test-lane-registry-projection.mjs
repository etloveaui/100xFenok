 ...
 * - Emitter unit: 20 lanes, exact allowed key set, owner_workflow basename only.
 */
...
assert.equal(projection.lanes.length, 20, "projection must carry all 20 registry lanes");
assert.equal(projection.lane_count, 20);
