 ...
 * - Emitter unit: 27 lanes, exact allowed key set, owner_workflow basename only.
 */
...
assert.equal(projection.lanes.length, 27, "projection must carry all 27 registry lanes");
assert.equal(projection.lane_count, 27);
