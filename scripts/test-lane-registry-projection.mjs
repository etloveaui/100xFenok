 ...
 * - Emitter unit: 26 lanes, exact allowed key set, owner_workflow basename only.
 */
...
assert.equal(projection.lanes.length, 26, "projection must carry all 26 registry lanes");
assert.equal(projection.lane_count, 26);
