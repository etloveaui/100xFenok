#!/usr/bin/env python3
"""
SlickCharts Dow Jones historical returns scraper.

Usage:
    python scripts/scrapers/dowjones-returns-scraper.py --output data/dowjones_returns.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/dowjones/returns"
DEFAULT_OUTPUT = Path(__file__).with_name("dowjones_returns.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape Dow Jones historical returns from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
