#!/usr/bin/env python3
"""
SlickCharts S&P 500 historical returns scraper.

Usage:
    python scripts/scrapers/sp500-returns-scraper.py --output data/sp500_returns.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/sp500/returns"
DEFAULT_OUTPUT = Path(__file__).with_name("sp500_returns.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape S&P 500 historical returns from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
