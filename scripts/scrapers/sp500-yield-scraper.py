#!/usr/bin/env python3
"""
SlickCharts S&P 500 dividend yield scraper.

Usage:
    python scripts/scrapers/sp500-yield-scraper.py --output data/sp500_yield.json
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape S&P 500 dividend yield from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
...
def main() -> None:
    ...
    print(f"S&P 500 Dividend Yield: {data['yield']}%")
