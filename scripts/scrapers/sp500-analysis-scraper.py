#!/usr/bin/env python3
"""
SlickCharts S&P 500 cumulative weight analysis scraper.

Usage:
    python scripts/scrapers/sp500-analysis-scraper.py --output data/sp500_analysis.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/sp500/analysis"
DEFAULT_OUTPUT = Path(__file__).with_name("sp500_analysis.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape S&P 500 cumulative weight analysis from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
