#!/usr/bin/env python3
"""
SlickCharts S&P 500 YTD performance scraper.

Usage:
    python scripts/scrapers/sp500-performance-scraper.py --output data/sp500_performance.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/sp500/performance"
DEFAULT_OUTPUT = Path(__file__).with_name("sp500_performance.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape S&P 500 YTD performance from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
