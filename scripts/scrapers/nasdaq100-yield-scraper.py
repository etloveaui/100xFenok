#!/usr/bin/env python3
"""
SlickCharts Nasdaq 100 dividend yield scraper.

Usage:
    python scripts/scrapers/nasdaq100-yield-scraper.py --output data/nasdaq100_yield.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/nasdaq100/yield"
DEFAULT_OUTPUT = Path(__file__).with_name("nasdaq100_yield.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape Nasdaq 100 dividend yield from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
...
def main() -> None:
    ...
    print(f"Nasdaq 100 Dividend Yield: {data['yield']}%")
