#!/usr/bin/env python3
"""
SlickCharts Nasdaq 100 YTD performance scraper.

Usage:
    python scripts/scrapers/nasdaq100-performance-scraper.py --output data/nasdaq100_performance.json
"""
...
SOURCE_URL = "https://www.slickcharts.com/nasdaq100/performance"
DEFAULT_OUTPUT = Path(__file__).with_name("nasdaq100_performance.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Scrape Nasdaq 100 YTD performance from SlickCharts.")
    parser.add_argument(
        "--output",
        type=Path,
