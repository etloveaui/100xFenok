...
Usage:
    python scripts/scrapers/btc-returns-scraper.py --output data/slickcharts/btc-returns.json --pretty
"""
...
DEFAULT_OUTPUT = REPO_ROOT / "data" / "slickcharts" / "btc-returns.json"
