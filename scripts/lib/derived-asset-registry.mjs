...
export const DERIVED_WRITER_RECOVERY_CONTRACTS = Object.freeze({
  ...
  "scripts/build-sec13f-bridge-index.mjs": "rebuild_from_inputs",
...
const assets = [
  ...
  asset({
    id: "sec13f_bridge_index",
    label: "SEC 13F bridge index (live, honest 424/1,026 coverage)",
    outputs: [output("data/computed/sec13f_bridge_index.json")],
    owner_workflow: ".github/workflows/build-stocks-analyzer.yml",
    writer: "scripts/build-sec13f-bridge-index.mjs",
    inputs: [
      lane("global_scouter"),
      lane("sec_13f"),
      derived("stock_action_index"),
      derived("market_facts"),
      repoPath("data/yf/finance"),
    ],
    cadence: STOCKS_ANALYZER_DAILY,
    privacy_class: "public_mirror",
    public_outputs: [output("100xfenok-next/public/data/computed/sec13f_bridge_index.json")],
    retention: SNAPSHOT,
    recovery: "rebuild_from_inputs",
  }),
  asset({
