...
if (gateErrors.length) {
  ...
  fs.writeFileSync(path.join(ROOT, "data/computed/feno-rim-recovery/RIM_MECHANICAL_FORECAST_VALIDATION_EXT.json"),
...
fs.writeFileSync(path.join(ROOT, "data/computed/feno-rim-recovery/RIM_MECHANICAL_FORECAST_VALIDATION_EXT.json"), JSON.stringify(validation, null, 2) + "\n");
fs.writeFileSync(path.join(ROOT, "data/computed/feno-rim-recovery/r1-edgar-panel-ext.json"), JSON.stringify({
