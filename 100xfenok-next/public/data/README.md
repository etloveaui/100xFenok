...
- 1,066 stock profiles + ETFs (22) + Economic Indicators (1,076 records) + raw preservation files (9)
- **v2.4.0**: 2026-09-06 weekly refresh (2026-09-04 source); downstream screener artifacts use the existing hosted rebuild path; 1,076 indicators
