...
├── indicators/              # v2.1.0
│   └── economic.json        # Economic indicators (1,066 records)
└── raw/                     # v2.3.0
...
| `per_bands` | 98.3% (1,046) | PER/PBR bands with FY-4~FY+3 values where available |
...
| `raw/company_master_m_company.json` | 5,815 | M_Company master universe table |
