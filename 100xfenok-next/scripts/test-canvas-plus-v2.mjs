...
assert.ok(routeContract.includes("page_route_count: 58"), "route contract page count must include V2 lab routes");
assert.ok(routeContract.includes("out_of_scope_count: 15"), "route contract must classify V2 lab routes as out of scope");
