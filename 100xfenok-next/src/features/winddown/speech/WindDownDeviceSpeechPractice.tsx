    ...
    >
      <div className="flex gap-2">
        {controls === "listen-and-speak" ? (
          <button
            ...
            className="min-h-[44px] flex-1 rounded-xl border border-[var(--wd-border)] bg-[var(--wd-surface-raised)] px-3 text-[12px] font-black text-[var(--wd-text)] disabled:opacity-35"
          >
        ...
        <button
          ...
          className="min-h-[44px] flex-1 rounded-xl bg-[var(--wd-listening)] px-3 text-[12px] font-black text-[var(--wd-bg)] disabled:opacity-35"
        >
      ...
      {speech.phase === "heard" ? (
        <div aria-live="polite" className="mt-3 text-center">
          ...
          <p className="mt-1 text-[12px] font-bold text-[var(--wd-listening)]">
      ...
      {speech.phase === "error" && speech.message ? (
        <p
          role="status"
          className="mt-3 text-center text-[12px] font-bold leading-5 text-[var(--wd-warning)]"
        >
          {speech.message}
        </p>
      ) : null}

      <p className="mt-3 text-center text-[12px] font-bold leading-4 text-[var(--wd-text-muted)]">
