...
const variantClass: Record<Variant, string> = {
  ...
  tab: "bg-[#f1f5f9] text-[#475569] hover:bg-[#e2e8f0] border border-transparent data-[active=true]:bg-white data-[active=true]:border-[#e2e8f0] data-[active=true]:text-[#1B73D3] data-[active=true]:shadow-sm",
};
