...
const SCREEN_LABELS: Record<string, { label: string; kbd?: string }> = {
  "/": { label: "홈" },
  "/market-valuation": { label: "시장" },
  "/market-valuation/structure": { label: "시장 구조" },
  "/regime": { label: "시장 국면" },
  "/market/events": { label: "시장 이벤트" },
  "/sectors": { label: "섹터 히트맵", kbd: "g h" },
  "/etfs": { label: "ETF" },
  "/etfs/compare": { label: "ETF 비교" },
  "/etfs/new": { label: "신규 상장 ETF" },
  "/screener": { label: "스크리너", kbd: "g s" },
  "/superinvestors": { label: "투자자" },
  "/portfolio": { label: "포트폴리오" },
  "/ib": { label: "무한매수" },
  "/vr": { label: "VR 전략 가이드" },
  "/radar": { label: "Market Radar" },
  "/macro-chart": { label: "차트" },
  "/multichart": { label: "시장 비교" },
};
