...
export default function MonaWindDownEntry({ locked }: { locked: boolean }) {
  if (locked) {
    return (
      <div className="mt-4 rounded-2xl border border-[var(--wd-line)] px-4 py-3 opacity-50">
        <p className="text-[12px] font-semibold tracking-[0.14em] text-[var(--wd-muted)]">WIND DOWN</p>
  ...
  return (
    ...
    >
      <span>
        <span className="block text-[12px] font-semibold tracking-[0.14em]">WIND DOWN</span>
        <span className="mt-1 block text-[13px] font-semibold">오늘의 퀘스트 열기</span>
      </span>
