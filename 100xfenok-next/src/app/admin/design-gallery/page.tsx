...
const ITEMS: DesignItem[] = [
  ...
  },
  {
    ...
    category: "dataviz",
    description: "Numbers animate from 0 to target value on scroll into view. Adds life to otherwise static dashboards.",
  ...
  },
  {
    ...
    category: "layout",
    description: "Universal search/action palette triggered by keyboard shortcut. Navigate anywhere, execute any action.",
  ...
  },
  {
    ...
    category: "notification",
    description: "Top-of-page banner for important announcements. Dismissible with cookie/localStorage memory.",
