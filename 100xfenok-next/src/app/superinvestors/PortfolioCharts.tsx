...
// Portfolio views + factor exposure loaders live in a chart-free module so
// InsightsTab can fetch this data without statically importing chart.js.
// Re-exported here for backward compatibility with existing import paths.
export { loadPortfolioViews, loadFactorExposuresSummary } from "./portfolioViewsLoader";
