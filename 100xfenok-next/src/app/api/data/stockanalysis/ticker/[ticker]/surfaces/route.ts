...
const SURFACE_SPECS: SurfaceSpec[] = [
  ...
  {
    surface: "market_gainers_week",
    label: "주간 상승",
    section: "markets",
    tickerKeys: ["symbol"],
    fields: ["symbol", "company_name", "change_1w", "stock_price", "volume", "market_cap"],
    limit: 4,
  },
  {
    surface: "market_gainers_month",
    label: "월간 상승",
    section: "markets",
    tickerKeys: ["symbol"],
    fields: ["symbol", "company_name", "change_1m", "stock_price", "volume", "market_cap"],
    limit: 4,
  },
  {
    surface: "market_losers_ytd",
    label: "YTD 하락",
    section: "markets",
    tickerKeys: ["symbol"],
    fields: ["symbol", "company_name", "change_ytd", "stock_price", "volume", "market_cap"],
    limit: 4,
  },
  {
  ...
  {
    surface: "ipos_statistics",
    label: "IPO 통계",
    section: "ipo",
    tickerKeys: ["symbol", "s"],
    fields: ["date", "symbol", "name"],
    limit: 4,
  },
  {
    surface: "ipos_withdrawn",
    label: "철회 IPO",
    section: "ipo",
    tickerKeys: ["symbol", "s"],
    fields: ["withdrawn_date", "date", "symbol", "company_name", "name", "price_range", "shares_offered"],
    limit: 4,
  },
  {
