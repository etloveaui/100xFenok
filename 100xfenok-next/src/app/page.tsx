      ...
      <section className="command-toolbar" role="toolbar" aria-label="Dashboard controls">
        ...
        {activeTab === 'overview' && (
          <>
            ...
            <a href="/posts/2026-02-21_tariff-ruling-comprehensive.html"
              ...
              <div className="flex items-center gap-4 px-5 py-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono">2026.02.21</span>
                  </div>
                ...
                <div className="flex-shrink-0 text-slate-300 group-hover:text-amber-600
                                transition-colors">
