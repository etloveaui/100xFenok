...
const MACRO_PLAYBOOKS = [
  {
    ...
    href: "/macro-chart?series=sp500,vix,tga,DGS10,HY_spread,M2SL&transform=rebase100,raw,rebase100,raw,raw,yoy&range=10Y&hidden=vix&axis=vix:right,DGS10:right,HY_spread:right",
  },
  {
    title: "경기활동",
  ...
  },
  {
    ...
    href: "/macro-chart?series=bank_credit,deposits,fdic_tier1,HY_spread,DGS10&transform=yoy,yoy,raw,raw,raw&range=10Y&axis=fdic_tier1:right,HY_spread:right,DGS10:right",
  },
];
