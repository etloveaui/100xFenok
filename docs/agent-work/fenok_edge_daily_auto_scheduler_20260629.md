...
| --- | --- | --- | --- | --- |
| S0 active stock scoring | PUBLIC, not DAILY/GATED | `fenok-edge-krx-daily.yml` runs KST Mon-Fri 19:30 for bounded KRX private daily fetch; `fenok-edge-daily.yml` runs KST Tue-Sat 09:30, refreshing FINRA 7-day-to-yesterday and one rolling OCC batch | 1,066 scored/public stocks; KRX 338/338, FINRA metric-ready 579/579 for active plain-US rows, OCC 228/637, Asia ex-Taiwan 91 outside current daily-source workstream; strict `qa:fenok-s0-daily-gated` remains red | `occ_full_us_source_ready`, `no_asia_ex_taiwan_gap`, `daily_ready` |
...
- Missing daily proof: source/proxy rows are explicitly `not_public_scoring`; KRX covers 338/338 Korea rows, FINRA metric-ready covers 579/579 active plain-US rows, OCC covers 228/637 US-bucket rows, the latest bounded US run covers 8/637 reference tickers, and 91 Asia ex-Taiwan rows remain outside the current daily-source workstream.
