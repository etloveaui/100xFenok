...
- `scripts/fetch-fenok-occ-options-volume.mjs --s0-occ-missing --batch-size 25 --batch-index 0 --date 20260626 --max-requests 50 --plan-only` selected 25 active plain-US OCC gaps for the 2026-06-30 eighth bounded OCC slice. It added 6 usable OCC rows; 19 plain-US gaps remain unverified because failed attempts were not promoted to permanent no-listed-options evidence.
