...
- Live OCC gap filling remains approval-gated. Current bounded follow-up budget is 19 tickers * 2 sides = 38 side requests: one 19-ticker follow-up batch at 38 side requests, or a separate no-options proof path if the collector can persist both C/P sides as accepted no-record evidence.
