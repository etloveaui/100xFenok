...
- P5 SEO cleanup owns a public sitemap, live Worker-origin metadata base, stock/ETF/post canonical URLs, robots disallow for admin/live/travel aliases, and removal of the permanent `/travel/*` admin redirect. 2026-07-07 update: the `100xfenok` Cloudflare Pages project was deleted after legacy deployment purge; the Worker origin is the canonical app origin.
