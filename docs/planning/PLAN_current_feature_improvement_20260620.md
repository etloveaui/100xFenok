...
**P15-0/P9-G multichart restoration contract added 2026-06-24; P16 nav contract updated 2026-06-25**:
...
requests, and show the legacy compare controls/results. P16 keeps header
Analytics narrow as Radar/Insights/`워크벤치`, but promotes `/macro-chart` to an
official AppShell `차트` entry; `/multichart` shares that chart active state.
...
**P15-Fusion draft contract added 2026-06-24**:
`CONTRACT_macro_chart_stooq_fusion_20260624.md` defines the next pivot: add
owner-Worker-proxied Stooq stock/ETF/index series as delimiter-safe dynamic
series inside `/macro-chart`, preserving the existing transform/alignment/URL/
