...
- The coverage index still holds `daily=false` and `gated=false`: two bounded live batches reduced fetchable daily 1Y continuity gaps `584 -> 518 -> 441`, while 2 fetchable required-history gaps also remain.
