...
- [ ] P15-Fusion: owner pivot after P15-A/B/C/D. Stooq stock/ETF/index series should become a source type inside `/macro-chart`, so market symbols and macro series compare in one chart. Draft contract: `CONTRACT_macro_chart_stooq_fusion_20260624.md`. Implementation and further deploy are held until owner chooses whether to forward-revert the deployed P15 context-link slice or absorb it into Fusion.
