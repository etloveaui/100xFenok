...
> **Status**: Historical rollout review. v5 became default on 2026-06-26,
> then v6 became the production default on 2026-07-03. The current selector is
> `100xfenok-next/src/lib/design/version.ts`; the review below preserves the v5
> rollout decision and its incremental-hardening notes.
