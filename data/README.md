...
- Benchmarks latest: 31,981 records, 2010-01-01 ~ 2026-07-10, 38 sections (micro_sectors +과창판 STAR50), 863 S&P 500 data points (DEC-275 history-preservation merge)
...
- Yardney: Feno Yardeni S&P 500 fair value model, 1,888 weekly public valuation records, latest 2026-07-03 fair value 6,422.50 and premium +16.52%; benchmark input is 2026-07-10, while that date remains pending a matching FRED yield observation; raw bond-yield components are excluded from public payloads
...
- 1,064 stock profiles + ETFs (22) + Economic Indicators (1,068 records) + raw preservation files (9)
