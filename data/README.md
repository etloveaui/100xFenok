...
- 1,066 stock profiles + ETFs (22) + Economic Indicators (1,072 records) + raw preservation files (9)
- **v2.4.0**: 2026-08-16 weekly refresh (2026-08-14 source); screener artifacts rebuilt from this export; 1,072 indicators
