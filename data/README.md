...
- 1,065 stock profiles + ETFs (22) + Economic Indicators (1,069 records) + raw preservation files (9)
- **v2.4.0**: 2026-07-24 weekly refresh; screener artifacts rebuilt from this export
