...
| [global-scouter/](global-scouter/README.md) | 1,085 | On-demand | Global Scouter Tool |
...
- Benchmarks latest: 32,095 records, 2010-01-01 ~ 2026-08-02, 38 sections (micro_sectors +과창판 STAR50), 866 S&P 500 data points (DEC-275 history-preservation merge)
...
- Yardney: Feno Yardeni S&P 500 fair value model, 1,891 weekly public valuation records through 2026-07-24, latest fair value 6,275.72 and premium +18.11%; all benchmark rows matched FRED yield observations; raw bond-yield components are excluded from public payloads
- RIM inputs: `computed/rim-index/inputs.json` is generated by `scripts/build-rim-index.mjs` and mirrored to Next public data; it exposes input/source tiers only, not public fair values or target prices
...
- Activity surveys: 930 records; OECD CLI through 2026-06, major-country manufacturing/services PMI and ISM components through 2026-06
...
- 1,067 stock profiles + ETFs (22) + Economic Indicators (1,070 records) + raw preservation files (9)
- **v2.4.0**: 2026-07-31 weekly refresh; screener artifacts rebuilt from this export. Added Kioxia Holdings (285A.T) and CXMT A (688825.SS); both carry provider-truth null current price for their Tokyo/Shanghai listings, and CXMT has no forward consensus yet
