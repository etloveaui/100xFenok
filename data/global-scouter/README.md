...
├── indicators/              # v2.1.0
│   └── economic.json        # Economic indicators (1,076 records)
├── raw/                     # v2.3.0
...
| `raw/company_master_m_company.json` | 5,763 | M_Company master universe table |
...
| `raw/workbook_inventory.json` | 1,348 sheets | Workbook sheet inventory and categories |
