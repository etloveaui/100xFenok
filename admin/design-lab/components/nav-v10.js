...
const NavConfig = {
  ...
  notificationStorageKey: 'nav_notifications_v10',
};
...
class LiveTicker {
  ...
  render() {
    ...
    const tickerEls = this.container.querySelectorAll('[data-ticker-symbol]');
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (searchInput && searchSuggestions) {
    window.searchAutocomplete = new SearchAutocomplete(searchInput, searchSuggestions);
  }
  ...
  console.log('Nav V10 initialized');
});
